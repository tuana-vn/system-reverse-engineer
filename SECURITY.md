...
Do not file public issues containing credentials, customer source code, private repository excerpts, internal hostnames, confidential architecture, access tokens, or other sensitive material.

If you discover a security issue in this repository itself, report it privately through GitHub's security advisory mechanism when available.
